...
function outputLog(data, thrownError) {
    ...
    else if (data.statusCode < constants_1.HTTP_STATUS_BAD_REQUEST) {
...
function logger(ctx, next) {
    return __awaiter(this, void 0, void 0, function () {
        var start, logData, errorThrown, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    e_1 = _a.sent();
                    errorThrown = e_1;
                    logData.errorMessage = e_1.message;
                    logData.errorStack = e_1.stack;
                    logData.statusCode = e_1.status || constants_1.HTTP_STATUS_500;
                    if (e_1.data) {
                        logData.data = e_1.data;
                    }
                    return [3 /*break*/, 4];
                case 4:
